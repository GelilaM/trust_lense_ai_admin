...
export default function LoginPage() {
  ...
  const { mutate: signIn, loading, error: apiError } = useApiMutation<any, UserProfileResponse>("/auth/sign-in")
      ...
      <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="flex flex-col items-center">
            <h1 className="text-2xl font-bold tracking-tight text-brand-navy">TrustLens AI</h1>
          </div>
        </div>
        ...
        <PremiumCard className="border-none shadow-2xl shadow-blue-900/5">
          <CardContent className="space-y-6 pt-10 px-8 pb-10">
            <div className="space-y-2 text-center">
              <h2 className="text-2xl font-bold tracking-tight text-brand-navy">Sign in to TrustLens AI</h2>
            ...
            <form onSubmit={handleSignIn} className="space-y-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold text-brand-navy/60 label-caps">Phone Number</label>
                <Input 
                  type="text" 
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <label className="text-sm font-bold text-brand-navy/60 label-caps">Password</label>
                  <a href="#" className="text-xs font-bold text-brand-teal hover:underline underline-offset-4">
                    Forgot password?
                  </a>
                </div>
                <Input 
              ...
              <div className="flex items-center gap-2 pt-2">
                ...
                />
                <label htmlFor="remember" className="text-sm font-medium text-brand-navy/60">
                  Remember me
                </label>
              </div>
