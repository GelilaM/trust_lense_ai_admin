...
## Image Placeholders (Nano Banana)

When building layouts or landing pages that require temporary visuals:

- Use the **nano-banana-placeholder-images** skill
- Generate neutral, design-safe placeholder images
- Match image aspect ratios to layout (`16:9`, `4:3`, `1:1`)
- Always use `next/image` when rendering generated images
